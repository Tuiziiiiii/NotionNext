...
const CONFIG = {
  ...
  PROXIO_WELCOME_TEXT: 'HELLO!', // 欢迎文字，留空则不启用

  // 英雄区块导航
  PROXIO_HERO_ENABLE: true, // 开启英雄区
  PROXIO_HERO_TITLE_1: '致力于商业设计', // 英雄区文字
  PROXIO_HERO_TITLE_2: '用设计来为商业锦上添花', // 英雄区文字
  // 英雄区两个按钮，如果TEXT留空则隐藏按钮
  PROXIO_HERO_BUTTON_1_TEXT: '看看案例', // 英雄区按钮
  PROXIO_HERO_BUTTON_1_URL:
    'https://keyijihua.vercel.app/', // 英雄区按钮
  PROXIO_HERO_BUTTON_2_TEXT: '关注我们', // 英雄区按钮
  PROXIO_HERO_BUTTON_2_URL: 'https://keyijihua.vercel.app/', // 英雄区按钮
